...
import { createCry, uploadCryMedia } from '../api';
import { U, UG, UR, US } from '../theme';
import { Btn, Card, Chips, Gradient, Slider, Sticker, Stepper, T, pop, tap, yay } from '../ui';
...
export function TearsScreen() {
  ...
  return (
    <ScrollView
      ...
      <Btn label="Поставить диагноз" icon={STK.crystal} onPress={diagnose} g={UG.candy} />
      ...
      {result && (
        <Gradient g={UG.bubble} radius={UR.xl} style={styles.result}>
          ...
          <Btn label={saving ? 'Сохраняю…' : 'Сохранить в архив'} icon={STK.scroll} onPress={save} g={UG.pingA} disabled={saving} style={{ alignSelf: 'stretch' }} />
